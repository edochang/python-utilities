...
with open(strSourceFullFilePath, 'r', encoding='utf-8') as file:
...
split(open(strSourceFullFilePath, 'r', encoding='utf-8'),delimiter='\t', row_limit=decChunkCount,output_name_template=strTargetFileNameTemplate, output_path=strWorkingDirectory)
